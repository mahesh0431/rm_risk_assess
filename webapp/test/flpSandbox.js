		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GRC Collaborative Risk Assessment",
									"targetURL": "#grcriskassess-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"grcriskassess-display": {
								"semanticObject": "grcriskassess",
								"action": "display",
								"description": "Collaborative Risk Assessment",
								"title": "GRC Collaborative Risk Assessment",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"url": sap.ui.require.toUrl("grcriskassess")
								}
							}
						}
					}
